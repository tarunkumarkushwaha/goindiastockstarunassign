    ...
    return (
        <>
            <div className='flex flex-row justify-center'>
                <h1 className="bg-gray-800 md:bg-gray-50 mx-auto font-bold md:inline-flex hidden text-xl text-white md:text-orange-700">Discussion Forum</h1>
                ...
                <h1 className="bg-gray-800 md:bg-gray-50 mx-auto font-bold md:inline-flex hidden text-xl text-white md:text-orange-700">Market Stories</h1>
